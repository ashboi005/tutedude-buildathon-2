...
import { vendorSignUpSchema } from "@/modules/auth/schemas";
...
export function VendorSignUpForm() {
  ...
  async function onSubmit(data: z.infer<typeof vendorSignUpSchema>) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="chaat@vaala.com" type="email" {...field} />
              </FormControl>
